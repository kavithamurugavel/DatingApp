...
// check link https://github.com/auth0/angular2-jwt under usage: injection
...
@NgModule({
   ...
   // for the JwtModule part check link: https://github.com/auth0/angular2-jwt under usage:injection part
   imports: [
      BrowserModule,
      HttpClientModule,
      FormsModule,
